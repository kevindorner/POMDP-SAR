...
% profile on
%% Parameters
P_survival=[0.9 0.9 0.9 0.9]; %Survival probabilities
Discount=0.9; Reward=100; 
VictimsLocation=[48 72 117 123]; %Location of each victim (starting from index 1)
NrRobots=1; Nr_victims=4; mapsize=12;
startingstate=0; 
...
%Array of inacessible waypoints
 exclude=[];
 exclude=[4 7:8 13 16:17 19:20 23 25 31 34:35 37 43 47 49 59:60 61:63 68 78:81 83:86 88:90 102 104:107 110:112 116 119 124 126 128:129 138 140:141 143];
...
nrStates=NrStates;
file = fopen('ExtendedCaseStudy.POMDP','w');
